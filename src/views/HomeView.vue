                          ...
                          <div class="card-body">                          
                            <ul class="steps steps-vertical">
                              <li
                                ...
                                :class="experience.isCurrent ? 'step-primary' : ''"
                              >
                                <div class="flex flex-row mt-2 p-1">
                     ...
                     <div class="card bg-base-200">
                      <div class="card-body text-center">
                        <div class="flex flex-row justify-center content-center">
                          <VIcon icon="twitter" height="72px"/>
                          <VIcon icon="instagram" height="72px"/>
                          <VIcon icon="linkedin" height="72px"/>
                          <VIcon icon="github" height="72px"/>
                            <!-- <VIcon icon="youtube" height="72px"/> -->
                            <!-- <VIcon icon="medium" height="72px"/> -->
                        </div>
                      </div>
                    </div>
                  </TabPanel>
